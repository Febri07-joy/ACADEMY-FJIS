      ...
      card.innerHTML = `
        ...
        <div class="actions">
          ...
          <button
            ...
            disabled
            aria-disabled="true"
            title="Pendaftaran beasiswa ini sudah ditutup"
            style="background:#dc2626 !important;color:#ffffff !important;border-color:#dc2626 !important;opacity:1 !important;cursor:not-allowed;"
          >
            ${actionText}
          </button>`
              : `
